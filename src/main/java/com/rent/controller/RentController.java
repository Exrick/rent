...
public class RentController extends BaseController<Rent,Integer>{
    ...
    public Result<Object> post(@RequestParam String token,
        ...
        rent.setProvinceName(regionService.get(rent.getProvince()).getName());
        rent.setCityName(regionService.get(rent.getCity()).getName());
        rent.setAreaName(regionService.get(rent.getArea()).getName());
